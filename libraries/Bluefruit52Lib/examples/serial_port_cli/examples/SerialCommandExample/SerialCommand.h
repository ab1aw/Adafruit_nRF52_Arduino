...
class SerialCommand {
  public:
    SerialCommand(Stream &print, Stream &debugPrint, char terminator = '\r');      // Constructor with custom Stream object
    SerialCommand(Stream &print, char terminator = '\r');      // Constructor with custom Stream object
    SerialCommand(char terminator = '\r');      // Constructor with default Stream object
